...
function setup() {
  ...
  pendulum1 = new Pendulum(610,410);
  pendulum2 = new Pendulum(695,410);
  pendulum3 = new Pendulum(780,410);
  pendulum4 = new Pendulum(865,410);
  pendulum5 = new Pendulum(950,410);
